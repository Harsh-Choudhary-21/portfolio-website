  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-gradient-to-br from-blue-900 via-black to-red-900 relative">
      ...
      >
        ...
        {/* Summary Section */}
        <div className="min-w-full h-full flex items-center justify-center p-4 md:p-8">
          <div className="max-w-5xl text-left space-y-6 md:space-y-8 w-full">
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 md:mb-8 text-center">Professional Summary</h2>
            <div className="animated-container bg-gray-800/50 rounded-2xl p-6 md:p-8 lg:p-12 backdrop-blur-sm mx-4 transition-all duration-300 hover:bg-gray-700/60 hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105">
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p className="text-lg md:text-xl">
                  <strong className="text-white">Computer Science Student</strong> pursuing B.Tech degree with demonstrated expertise in <strong className="text-blue-400">Python programming</strong>, <strong className="text-blue-400">C++ development</strong>, and <strong className="text-blue-400">full-stack web development</strong>. Proven track record in <strong className="text-blue-400">machine learning</strong> and <strong className="text-blue-400">artificial intelligence</strong> applications.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  <div>
                    <h3 className="text-blue-400 font-semibold mb-2">Technical Expertise:</h3>
                    <ul className="text-sm space-y-1">
                      <li>• Software Development (Python, C++)</li>
                ...
                <p className="text-base md:text-lg mt-4">
                  Seeking <strong className="text-white">Software Developer</strong> or <strong className="text-white">Software Engineer</strong> opportunities to leverage programming skills and contribute to innovative technology solutions in a collaborative professional environment.
                </p>
              </div>
            </div>
          </div>
